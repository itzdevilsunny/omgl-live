...
export const VIDEO_FILTERS = [
  ...
  { id: 'neo',        name: 'NEO',         filter: 'none', isAR: true, thumb: '🕶️' },
  { id: 'bloom',      name: 'BLOOM',       filter: 'none', isAR: true, thumb: '🌸' },
  { id: 'neon',       name: 'NEON',        filter: 'none', isAR: true, thumb: '🧬' },
  { id: 'fire',       name: 'FIRE',        filter: 'none', isAR: true, thumb: '🔥' },
  { id: 'gold',       name: 'GOLD',        filter: 'none', isAR: true, thumb: '✨' },
  // Color Grading
        ...
        if (!faceEngineRef.current) {
            ...
            try {
                ...
                const assetsToLoad = [
                    ...
                    { id: 'fire',     path: '/filters/fire.png' },
                    { id: 'gold',     path: '/filters/gold.png' }
                ];
